...
from adaptive_evidence_vqa.data.base import load_json, save_jsonl
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--qa-path", required=True, help="Path to raw TVQA+ question JSON.")
    parser.add_argument("--subtitles-path", required=True, help="Path to raw TVQA+ subtitles JSON.")
...
def main() -> None:
    ...
    normalized = [
        normalize_tvqa_record(record, subtitles_map=subtitles_map, dataset_name="tvqa_plus")
